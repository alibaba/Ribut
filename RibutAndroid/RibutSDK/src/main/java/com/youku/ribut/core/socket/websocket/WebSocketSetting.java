...
public class WebSocketSetting {
    ...
    /**
     * ws 协议实现，默认为 {@link com.youku.ribut.core.socket.java_websocket.drafts.Draft_6455}，
    ...
    /**
     * 设置消息发射器，不设置则默认使用 {@link com.youku.ribut.core.socket.websocket.dispatcher.MainThreadResponseDelivery}.
