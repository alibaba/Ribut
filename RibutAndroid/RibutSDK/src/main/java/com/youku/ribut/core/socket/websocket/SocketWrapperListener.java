...
public interface SocketWrapperListener {
     ...
     *
     * @param request 发送的请求
     * @param type    失败类型：{@link com.youku.ribut.core.socket.websocket.response.ErrorResponse#ERROR_NO_CONNECT} 未连接、
     *                {@link com.youku.ribut.core.socket.websocket.response.ErrorResponse#ERROR_UNKNOWN} 未知错误、
     *                {@link com.youku.ribut.core.socket.websocket.response.ErrorResponse#ERROR_UN_INIT} 初始化未完成
     */
